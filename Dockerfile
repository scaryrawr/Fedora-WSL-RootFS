...
RUN dnf update -y
RUN dnf install --disablerepo="*" --enablerepo="copr:copr.fedorainfracloud.org:scaryrawr:mesa-d3d12" mesa-dri-drivers mesa-d3d12 mesa-va-drivers mesa-vdpau-drivers -y
